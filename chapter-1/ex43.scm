...
;; f(f(...(f(x))...)). For example, if f is the function x x + 1, then
;; the nth repeated application of f is the function x x + n. If f is
;; the operation of squaring a number, then the nth repeated
;; application of f is the function that raises its argument to the
;; 2nth power. Write a procedure that takes as inputs a procedure that
